...
export default function ScatterPlot(props){
    ...
    useEffect(()=>{
            ...
            svg.selectAll('.y-axis').remove(); //remove all the y-axis before drawing the new y-axis
            svg.selectAll('.x-axis').remove(); //remove all the x-axis before drawing the new x-axis
